...
* *************************** */
async function deleteVehicleByInventoryId(inv_id) {
  try {
...
module.exports = { getClassifications, getInventoryByClassificationId, getVehicleByInventoryId, registerClassification, checkExistingClassification, registerInventory, updateInventory, deleteVehicleByInventoryId }; //We export it as what is returned will be handled by a utility.